...
.method public constructor <init>(Lcom/oneplus/support/lifecycle/LifecycleOwner;)V
    .locals 1
    .param p1, "provider"    # Lcom/oneplus/support/lifecycle/LifecycleOwner;
...
.method private backwardPass(Lcom/oneplus/support/lifecycle/LifecycleOwner;)V
    .locals 5
    .param p1, "lifecycleOwner"    # Lcom/oneplus/support/lifecycle/LifecycleOwner;
    ...
    .line 302
    .local v0, "descendingIterator":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Lcom/oneplus/support/lifecycle/LifecycleObserver;Lcom/oneplus/support/lifecycle/LifecycleRegistry$ObserverWithState;>;>;"
    :goto_0
    ...
    .line 304
    .local v1, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/oneplus/support/lifecycle/LifecycleObserver;Lcom/oneplus/support/lifecycle/LifecycleRegistry$ObserverWithState;>;"
    ...
    .line 305
    .local v2, "observer":Lcom/oneplus/support/lifecycle/LifecycleRegistry$ObserverWithState;
    :goto_1
    ...
    .line 308
    .local v3, "event":Lcom/oneplus/support/lifecycle/Lifecycle$Event;
    ...
    .line 311
    .end local v3    # "event":Lcom/oneplus/support/lifecycle/Lifecycle$Event;
    goto :goto_1

    .line 312
    .end local v1    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/oneplus/support/lifecycle/LifecycleObserver;Lcom/oneplus/support/lifecycle/LifecycleRegistry$ObserverWithState;>;"
    .end local v2    # "observer":Lcom/oneplus/support/lifecycle/LifecycleRegistry$ObserverWithState;
    :cond_0
    goto :goto_0
...
.method private calculateTargetState(Lcom/oneplus/support/lifecycle/LifecycleObserver;)Lcom/oneplus/support/lifecycle/Lifecycle$State;
    ...
    .line 154
    .local v0, "previous":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/oneplus/support/lifecycle/LifecycleObserver;Lcom/oneplus/support/lifecycle/LifecycleRegistry$ObserverWithState;>;"
    const/4 v1, 0x0
    ...
    .line 155
    .local v2, "siblingState":Lcom/oneplus/support/lifecycle/Lifecycle$State;
    :goto_0
    ...
    .line 157
    .local v1, "parentState":Lcom/oneplus/support/lifecycle/Lifecycle$State;
...
.method private static downEvent(Lcom/oneplus/support/lifecycle/Lifecycle$State;)Lcom/oneplus/support/lifecycle/Lifecycle$Event;
    .locals 3
    .param p0, "state"    # Lcom/oneplus/support/lifecycle/Lifecycle$State;
...
.method private forwardPass(Lcom/oneplus/support/lifecycle/LifecycleOwner;)V
    ...
    .line 287
    .local v0, "ascendingIterator":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Lcom/oneplus/support/lifecycle/LifecycleObserver;Lcom/oneplus/support/lifecycle/LifecycleRegistry$ObserverWithState;>;>;"
    :goto_0
    invoke-interface {v0}, Ljava/util/Iterator;->hasNext()Z
...
.method static getStateAfter(Lcom/oneplus/support/lifecycle/Lifecycle$Event;)Lcom/oneplus/support/lifecycle/Lifecycle$State;
    .locals 3
    .param p0, "event"    # Lcom/oneplus/support/lifecycle/Lifecycle$Event;
...
.method private isSynced()Z
    ...
    .line 147
    .local v0, "eldestObserverState":Lcom/oneplus/support/lifecycle/Lifecycle$State;
    ...
    .line 148
    .local v2, "newestObserverState":Lcom/oneplus/support/lifecycle/Lifecycle$State;
    if-ne v0, v2, :cond_1
...
.method static min(Lcom/oneplus/support/lifecycle/Lifecycle$State;Lcom/oneplus/support/lifecycle/Lifecycle$State;)Lcom/oneplus/support/lifecycle/Lifecycle$State;
    .locals 1
    .param p0, "state1"    # Lcom/oneplus/support/lifecycle/Lifecycle$State;
        .annotation build Lcom/oneplus/support/annotation/NonNull;
        .end annotation
    .end param
    .param p1, "state2"    # Lcom/oneplus/support/lifecycle/Lifecycle$State;
...
.method private moveToState(Lcom/oneplus/support/lifecycle/Lifecycle$State;)V
    .locals 2
    .param p1, "next"    # Lcom/oneplus/support/lifecycle/Lifecycle$State;
...
.method private sync()V
    ...
    .line 319
    .local v0, "lifecycleOwner":Lcom/oneplus/support/lifecycle/LifecycleOwner;
    if-nez v0, :cond_0
    ...
    .line 331
    .local v1, "newest":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/oneplus/support/lifecycle/LifecycleObserver;Lcom/oneplus/support/lifecycle/LifecycleRegistry$ObserverWithState;>;"
    ...
    .line 335
    .end local v1    # "newest":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lcom/oneplus/support/lifecycle/LifecycleObserver;Lcom/oneplus/support/lifecycle/LifecycleRegistry$ObserverWithState;>;"
    :cond_2
    goto :goto_0
...
.method public addObserver(Lcom/oneplus/support/lifecycle/LifecycleObserver;)V
    ...
    .line 163
    .local v0, "initialState":Lcom/oneplus/support/lifecycle/Lifecycle$State;
    :goto_0
    ...
    .line 164
    .local v1, "statefulObserver":Lcom/oneplus/support/lifecycle/LifecycleRegistry$ObserverWithState;
    iget-object v2, p0, Lcom/oneplus/support/lifecycle/LifecycleRegistry;->mObserverMap:Lcom/oneplus/support/collection/FastSafeIterableMap;
    ...
    .line 166
    .local v2, "previous":Lcom/oneplus/support/lifecycle/LifecycleRegistry$ObserverWithState;
    if-eqz v2, :cond_1
    ...
    .line 170
    .local v3, "lifecycleOwner":Lcom/oneplus/support/lifecycle/LifecycleOwner;
    if-nez v3, :cond_2
    ...
    .line 177
    .local v6, "targetState":Lcom/oneplus/support/lifecycle/Lifecycle$State;
...
.method public handleLifecycleEvent(Lcom/oneplus/support/lifecycle/Lifecycle$Event;)V
    ...
    .line 124
    .local v0, "next":Lcom/oneplus/support/lifecycle/Lifecycle$State;
